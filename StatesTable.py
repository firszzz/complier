...
class StatesTable(object):
    ...
    def __init__(self):
        ...
        self.States = {
            'S': {"": "F", '_': "ID", '\n': "S", '\t': "S", ' ': "S", "'": "STR1", ';': "D", '^': "D",
                  '+': "D", '*': "D", '-': "D", "/": "SL", "(": "BR", ")": "D", "[": "D", "]": "D", ",": "D", ".": "P",
                  ":": "D", "<": "D", ">": "D", "=": "D", "{": "COM1", "}": "ERR", "$": "16", "&": "8", "%": "2",
                  "?": "D", "@": "D"},
            'ID': {"": "F", '_': "ID", '\n': "F", '\t': "F", ' ': "F", '"': "F", "'": "F", ';': "F", '@': "F", '^': "F",
                   '+': "F", '*': "F", '-': "F", "/": "F", "(": "F", ")": "F", "[": "F", "]": "F", ",": "F", ".": "F",
                   ":": "F", "<": "F", ">": "F", "=": "F"},
            ...
            'NFPEO': {"": "F", '_': "ERR", '\n': "F", '\t': "F", ' ': "F", '"': "F", "'": "F", ';': "F", '@': "F",
                      ...
                      ",": "F", ".": "ERR", ":": "F", "<": "F", ">": "F", "=": "F"},
            'NFPE': {"": "F", '_': "ERR", '\n': "F", '\t': "F", ' ': "F", '"': "F", "'": "F", ';': "F", '@': "F",
                     '^': "F", '+': "NFPEO", '*': "F", '-': "NFPEO", "/": "F", "(": "F", ")": "F", "[": "F", "]": "F",
                     ",": "F", ".": "ERR", ":": "F", "<": "F", ">": "F", "=": "F"},
            '16': {"": "F", "A": "16", "B": "16", "C": "16", "D": "16", "E": "16", "F": "16", "a": "16", "b": "16",
                   "c": "16", "d": "16", "e": "16", "f": "16", "{": "F", '\n': "F", '\t': "F", ' ': "F", '"': "F",
                   "'": "F", ';': "F", '@': "F", '^': "F", '+': "F", '*': "F", '-': "F", "/": "F", "(": "F", ")": "F",
                   "[": "F", "]": "F", ",": "F", ".": "F", ":": "F", "<": "F", ">": "F", "=": "F"},
            '8': {"": "F", "{": "F", '\n': "F", '\t': "F", ' ': "F", '"': "F", "'": "F", ';': "F", '@': "F", '^': "F",
                  '+': "F", '*': "F", '-': "F", "/": "F", "(": "F", ")": "F", "[": "F", "]": "F", ",": "F", ".": "F",
